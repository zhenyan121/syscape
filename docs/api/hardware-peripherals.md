...
# Hardware and Peripherals API Reference

The Hardware and Peripherals headers provide comprehensive platform introspection for system identification, motherboards, BIOS/UEFI firmware, GPUs, display monitors, battery power, thermal sensors, audio endpoints, cameras, input devices, and printer queues.

All headers in this group require the **Hosted Full** profile with **strict C++17**.

---

## 1. System Identity and Hardware Inventory (`<syscape/hardware.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::hardware`
...
## 2. GPU and Video Controllers (`<syscape/gpu.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::gpu`
...
## 3. Displays and Monitors (`<syscape/display.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::display`
...
## 4. Power and Batteries (`<syscape/power.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::power`
...
## 5. Thermal and Fan Sensors (`<syscape/sensor.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::sensor`
...
## 6. Audio Devices (`<syscape/audio.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::audio`
...
## 7. Camera Devices (`<syscape/camera.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::camera`
...
## 8. Input Devices (`<syscape/input.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::input`
...
## 9. Printers (`<syscape/printer.hpp>`)

- **Profile**: Hosted Full (C++17)
- **Namespace**: `namespace syscape::printer`
