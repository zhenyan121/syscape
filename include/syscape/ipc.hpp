...
/// generic fallbacks.
/// @note Zephyr reports not_supported because no portable IPC inventory source
/// matching this module's semantics is available.

/// @note NuttX reports not_supported because no portable IPC enumeration
