...
/// @note NuttX reports not_supported because security facilities are board-
/// and configuration-specific and no explicit provider is implemented.
...
#include <syscape/detail/security/openharmony.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/security/hpux.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_HURD)
#include <syscape/detail/security/hurd.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
