...
/// @note NuttX reports not_supported because no portable audio-device
/// discovery backend is implemented.
...
#include <syscape/detail/audio/openharmony.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/audio/hpux.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_HURD)
#include <syscape/detail/audio/hurd.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/audio/minix.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_QNX)
#include <syscape/detail/audio/qnx.hpp>
