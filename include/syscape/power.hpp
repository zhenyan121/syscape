...
/// @note Zephyr reports not_supported because power devices are board-specific
/// and no explicit provider backend is implemented.

/// @note NuttX reports not_supported because power information is board- and
/// configuration-specific and no explicit provider is implemented.
...
#include <syscape/detail/power/openharmony.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/power/hurd.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/power/minix.hpp>
...
#include <syscape/detail/power/chibios.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_MYNEWT)
#include <syscape/detail/power/mynewt.hpp>
