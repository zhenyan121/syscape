...
/// @note NuttX implements current task identifiers, working directory,
...
#include <syscape/detail/process/emscripten.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_FUCHSIA)
#include <syscape/detail/process/fuchsia.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/process/ibmi.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_TIZEN)
#include <syscape/detail/process/tizen.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
