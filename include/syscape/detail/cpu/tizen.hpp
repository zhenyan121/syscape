#ifndef SYSCAPE_DETAIL_CPU_TIZEN_HPP
#define SYSCAPE_DETAIL_CPU_TIZEN_HPP
...
#if defined(SYSCAPE_TIZEN_CPU_COUNT)
    return validate_positive_u32_count(SYSCAPE_TIZEN_CPU_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_TIZEN_PHYSICAL_CPU_COUNT)
    return validate_positive_u32_count(SYSCAPE_TIZEN_PHYSICAL_CPU_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_TIZEN_PACKAGE_COUNT)
    return validate_positive_u32_count(SYSCAPE_TIZEN_PACKAGE_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
