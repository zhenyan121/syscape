#ifndef SYSCAPE_DETAIL_CPU_KAIOS_HPP
#define SYSCAPE_DETAIL_CPU_KAIOS_HPP
...
#if defined(SYSCAPE_KAIOS_CPU_COUNT)
    return validate_positive_u32_count(SYSCAPE_KAIOS_CPU_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_KAIOS_PHYSICAL_CPU_COUNT)
    return validate_positive_u32_count(SYSCAPE_KAIOS_PHYSICAL_CPU_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_KAIOS_PACKAGE_COUNT)
    return validate_positive_u32_count(SYSCAPE_KAIOS_PACKAGE_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
