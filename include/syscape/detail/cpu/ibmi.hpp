#ifndef SYSCAPE_DETAIL_CPU_IBMI_HPP
#define SYSCAPE_DETAIL_CPU_IBMI_HPP
...
#if defined(SYSCAPE_IBMI_CPU_COUNT)
...
#if defined(SYSCAPE_IBMI_PACKAGE_COUNT)
    return static_cast<std::uint32_t>(SYSCAPE_IBMI_PACKAGE_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
