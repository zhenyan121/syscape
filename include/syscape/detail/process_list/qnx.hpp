#ifndef SYSCAPE_DETAIL_PROCESS_LIST_QNX_HPP
#define SYSCAPE_DETAIL_PROCESS_LIST_QNX_HPP
...
inline result<std::vector<process_list::process_entry>> processes() {
    ...
    while (true) {
        ...
        // In the absence of guaranteed real UID/GID source without QNX devctl,
        // leave uid, gid, user_name, and ppid unpopulated (nullopt).
