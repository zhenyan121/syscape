#ifndef SYSCAPE_DETAIL_RESOURCE_AMIGAOS_HPP
#define SYSCAPE_DETAIL_RESOURCE_AMIGAOS_HPP
...
#if defined(SYSCAPE_AMIGAOS_MAX_FILES)
    return static_cast<std::uint64_t>(SYSCAPE_AMIGAOS_MAX_FILES);
#else
    return fail(errc::not_supported);
#endif
}
