#ifndef SYSCAPE_DETAIL_PROCESS_SAILFISH_HPP
#define SYSCAPE_DETAIL_PROCESS_SAILFISH_HPP
...
#if defined(SYSCAPE_SAILFISH_PID)
    return validate_positive_u32_count(SYSCAPE_SAILFISH_PID);
#else
...
#if defined(SYSCAPE_SAILFISH_PPID)
    return validate_u32_id(SYSCAPE_SAILFISH_PPID);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_SAILFISH_THREAD_COUNT)
    return validate_positive_u32_count(SYSCAPE_SAILFISH_THREAD_COUNT);
#else
    return fail(errc::not_supported);
#endif
}
...
#if defined(SYSCAPE_SAILFISH_TASK_PRIORITY)
    return process_posix::validate_priority(SYSCAPE_SAILFISH_TASK_PRIORITY, -20,
                                            19);
#elif defined(SYSCAPE_SAILFISH_PRIORITY)
    return process_posix::validate_priority(SYSCAPE_SAILFISH_PRIORITY, -20, 19);
#else
    return fail(errc::not_supported);
#endif
}
