#ifndef SYSCAPE_DETAIL_PROCESS_AMIGAOS_HPP
#define SYSCAPE_DETAIL_PROCESS_AMIGAOS_HPP
...
#if defined(SYSCAPE_AMIGAOS_TASK_PRIORITY)
    return static_cast<int>(SYSCAPE_AMIGAOS_TASK_PRIORITY);
#else
    return fail(errc::not_supported);
#endif
}
