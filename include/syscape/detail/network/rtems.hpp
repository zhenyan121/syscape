#ifndef SYSCAPE_DETAIL_NETWORK_RTEMS_HPP
#define SYSCAPE_DETAIL_NETWORK_RTEMS_HPP
...
inline result<std::vector<network_common::interface_record>> interfaces() {
    // Interface enumeration is supplied only by optional RTEMS networking
    // stacks, not by the RTEMS base SDK.
