#ifndef SYSCAPE_DETAIL_NETWORK_VXWORKS_HPP
#define SYSCAPE_DETAIL_NETWORK_VXWORKS_HPP
...
#if !defined(SYSCAPE_HAS_VXWORKS_GETIFADDRS)
#if defined(SYSCAPE_TARGET_VXWORKS_RTP) &&                                     \
    (defined(INCLUDE_IPWRAP_GETIFADDRS) ||                                     \
     defined(_WRS_CONFIG_INCLUDE_IPWRAP_GETIFADDRS) ||                         \
     defined(_WRS_CONFIG_IPWRAP_GETIFADDRS))
#define SYSCAPE_HAS_VXWORKS_GETIFADDRS 1
#else
#define SYSCAPE_HAS_VXWORKS_GETIFADDRS 0
#endif
#endif

#include <syscape/detail/network/common.hpp>
#if defined(SYSCAPE_HAS_VXWORKS_GETIFADDRS) && SYSCAPE_HAS_VXWORKS_GETIFADDRS
...
parse_dns_content(std::string_view content) {
...
inline result<network_common::dns_record> dns() {
    ...
    return parse_dns_content(*content);
}
