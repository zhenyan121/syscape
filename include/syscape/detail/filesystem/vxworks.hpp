#ifndef SYSCAPE_DETAIL_FILESYSTEM_VXWORKS_HPP
#define SYSCAPE_DETAIL_FILESYSTEM_VXWORKS_HPP
...
inline result<filesystem_common::space_snapshot> space(const std::string&) {
    return fail(errc::not_supported);
}
inline result<std::vector<filesystem_common::mount_record>> mounts() {
    return fail(errc::not_supported);
...
inline result<filesystem_common::path_length_snapshot>
max_component_length(const std::string&) {
    return fail(errc::not_supported);
}
inline result<filesystem_common::path_length_snapshot>
max_path_length(const std::string&) {
    return fail(errc::not_supported);
}
inline result<std::string> volume_id(const std::string&) {
    return fail(errc::not_supported);
}
