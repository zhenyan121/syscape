...
/// @note NuttX reports not_supported because storage topology and health are
/// board- and configuration-specific and no explicit provider is implemented.
...
#include <syscape/detail/storage/serenity.hpp>
...
#include <syscape/detail/storage/threadx.hpp>
