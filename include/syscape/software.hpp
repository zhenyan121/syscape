...
/// @note AIX, HP-UX, GNU/Hurd, SerenityOS, Redox OS, QNX, VxWorks, and RTEMS
...
/// @note NuttX reports not_supported because it has no system software
/// inventory matching this module's portable semantics.
...
#include <syscape/detail/software/hpux.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) && defined(SYSCAPE_TARGET_HURD)
#include <syscape/detail/software/hurd.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
