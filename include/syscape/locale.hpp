...
/// @note NuttX implements configuration-gated C-runtime locale, codeset, and
/// UTC-offset queries. Language lists, country codes, and time-zone identifiers
...
#include <syscape/detail/locale/openharmony.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
...
#include <syscape/detail/locale/hurd.hpp>
#elif !defined(SYSCAPE_FORCE_GENERIC_BACKEND) &&                               \
