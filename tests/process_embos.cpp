...
void test_process_queries() {
    ...
    expect(!rlim && rlim.error() == syscape::errc::not_supported,
           "resource limit must report not_supported on embOS");
}
