...
void test_user_queries() {
    ...
    expect(name && !name->empty(), "user name query must succeed");
    ...
    expect(shell.has_value(), "shell query must return the passwd field");
