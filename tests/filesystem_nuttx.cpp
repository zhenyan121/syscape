...
void test_filesystem_queries() {
    ...
    expect(!bad_id && bad_id.error() == syscape::errc::not_supported,
           "volume id remains unsupported regardless of path");
}
