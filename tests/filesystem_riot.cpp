...
void test_filesystem_queries() {
    ...
    expect(!max_path && max_path.error() == syscape::errc::not_supported,
           "max path length query must report not_supported on RIOT OS");
}
