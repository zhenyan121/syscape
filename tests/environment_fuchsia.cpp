...
void test_environment_queries() {
    ...
    const auto missing =
        syscape::environment::get("SYSCAPE_NONEXISTENT_VAR_Fuchsia");
    ...
    const std::string test_file =
        "/tmp/syscape_fuchsia_not_a_dir_" + std::to_string(::getpid());
    ...
    // Valid executable names must report not_supported on Fuchsia
