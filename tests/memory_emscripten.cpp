...
void test_memory_queries() {
    ...
    expect(
        page.has_value() || page.error() == syscape::errc::not_supported,
        "page_size_bytes must succeed or report not_supported on Emscripten");
    if (page.has_value()) {
