...
void test_process_queries() {
    ...
    expect(!limit && limit.error() == syscape::errc::not_supported,
           "resource limit must report not_supported on INTEGRITY");
}
